...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Create Workouts
        Workout.objects.create(name='Morning Cardio', description='Cardio session', duration=30)
        Workout.objects.create(name='Strength', description='Strength training', duration=45)
...
# MODELS (to be created in octofit_tracker/models.py):
# Team, Activity, Leaderboard, Workout
# User model esteso con campo team (ForeignKey Team)
